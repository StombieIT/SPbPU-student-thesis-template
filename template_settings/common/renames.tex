...
%Институт компьютерных наук итехнологий
...
%%
%%
\newcommand{\keywordsRu}{Адаптивный стриминг, Видеоконтент, Синхронизированные видеопотоки, Распределённые системы, Видеоплееры} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{Adaptive streaming, Video content, Synchronized video streams, Distributed systems, Video players} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
